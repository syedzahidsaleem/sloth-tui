//! Keyboard shortcuts, navigation dispatch, and input handling for App.
...
mod tests {
    ...
    async fn test_anime_tab_keys() {
        ...
        assert_eq!(
            app.state.anime_tab.focus,
            crate::tui::state::AnimePanelFocus::Episodes
        );
    ...
    async fn test_sports_tab_keys() {
        ...
        app.state
            .sports_tab
            .matches
            .push(crate::tui::state::LiveMatch {
        ...
        assert!(
            dispatched,
            "Enter on stream should dispatch playback action"
        );
    }
