//! Main application runtime loop, event polling, frame rendering, and terminal restoration.
...
impl App {
        ...
        std::io::Error: From<<B as ratatui::backend::Backend>::Error>,
    {
        ...
        let preferred = std::env::var(crate::player::ENV_SLOTH_PLAYER)
            .or_else(|_| std::env::var(crate::player::ENV_MOVIEBOX_PLAYER))
            .ok()
