//! Title cleaning and normalization routines for MovieBox search and display.

/// Cleans and normalizes raw MovieBox titles by stripping release tags, brackets, and resolution suffixes.
...
/// Normalizes human-readable language names to 2-character ISO codes.
